...
def partition(data,first,last):
    ...
    while not done:
        ...
        while leftmark <= rightmark and data[leftmark] >= pivotvalue: # Ubah operator pada pengecekan pivot value yang awalnya <= menjadi >=
            leftmark = leftmark + 1

        while data[rightmark] <= pivotvalue and rightmark >= leftmark: #Ubah operator pada pengecekan pivot valuye yang awalnya >= menjadi <=
